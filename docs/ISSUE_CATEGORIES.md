...
| EM4 | No "all chapters complete" / "you've explored everything" celebration screen | ✅ shipped 2026-05-19 — see DM7 above. ContentView.swift hosts AllChaptersCompleteOverlay; fires when DataStore.discoverProgress.count ≥ 171. Includes Boss Quiz total score across all 19 chapters, confetti via ParticleEmitter, and one-tap dismissal that persists hasSeenAllChaptersCelebration so the overlay shows once per student |
