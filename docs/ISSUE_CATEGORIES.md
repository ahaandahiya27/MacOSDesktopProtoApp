...
| G7 | Looking-Ahead callouts coverage | 🟡 87 of 171 scene files carry `LookingAheadCallout` after Ch 1 parity sweep; gap is Ch 2-7 + Ch 19 (~55 scenes still need NEET/JEE forward-links). Content-only PR work, no code change needed. |
| G8 | Try-At-Home callouts coverage | 🟡 same scope as G7 + same chapters; Ch 1 template-validated by `aedb591` |
