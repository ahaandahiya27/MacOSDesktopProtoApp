...
final class DataStore: ObservableObject {
    ...
    /// Total number of Discover scenes across the science pack: 12
    /// chapters × 9 scenes + 7 chapters × 20 scenes = 248. Hard-coded
    ...
    ///   - Ch.6-7: 9 → 20 scenes each (2026-05-21)
    static let totalDiscoverScenes = 248
