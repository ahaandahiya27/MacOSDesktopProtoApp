...
final class DataStore: ObservableObject {
    ...
    /// Total number of Discover scenes across the science pack: 9
    /// chapters × 9 scenes + 10 chapters × 20 scenes = 281. Hard-coded
    ...
    ///   - Ch.6-10: 9 → 20 scenes each (2026-05-21)
    static let totalDiscoverScenes = 281
