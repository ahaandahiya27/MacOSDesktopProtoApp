...
final class DataStore: ObservableObject {
    ...
    /// Total number of Discover scenes across the science pack: 8
    /// chapters × 9 scenes + 11 chapters × 20 scenes = 292. Hard-coded
    ...
    ///   - Ch.6-11: 9 → 20 scenes each (2026-05-21)
    static let totalDiscoverScenes = 292
