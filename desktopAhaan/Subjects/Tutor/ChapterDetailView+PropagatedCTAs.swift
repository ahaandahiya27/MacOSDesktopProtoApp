...
func socialScienceInteractives(
    ...
    if socialScienceInteractivesAreEnabled(forPackId: pack.id) {
        ...
        } else if chapter.id == "ssch03" {
            ClimateFactorsExplorer(chapterId: chapter.id)
        } else if chapter.id == "ssch02" {
            WeatherInstrumentLab(chapterId: chapter.id)
        } else if chapter.id == "ssch19" {
        ...
        } else if chapter.id == "ssch08" {
            SacredGeographyExplorer(chapterId: chapter.id)
