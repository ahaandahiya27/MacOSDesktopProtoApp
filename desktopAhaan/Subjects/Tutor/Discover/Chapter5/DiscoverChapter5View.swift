...
struct DiscoverChapter5View: View {
    ...
    private var sceneBuilders: [() -> AnyView] {
        [
            ...
            { AnyView(Scene9_BossQuiz_Ch5(pack: self.pack, chapter: self.chapter, onComplete: { score in self.markComplete(19, score: score, max: 5) })) }
        ]
    }
...
private struct StrongVsWeakAcidScene: View {
    let onComplete: () -> Void
...
private struct AcidRainQuizScene: View {
