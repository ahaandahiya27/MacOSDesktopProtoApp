...
struct Scene9_BossQuiz_Ch7: View {
    ...
    private func advance() {
        if currentQ < quiz.count - 1 { withAnimationRespectingReduceMotion(.easeInOut) { currentQ += 1 } }
        else { withAnimationRespectingReduceMotion(.easeInOut) { done = true; celebrate = true } }
    }
